            ...
            <main className="flex-grow px-8 pb-12">
                <div className="max-w-md mx-auto space-y-8">
                    <section className="bg-white p-8 rounded-lg ios-shadow space-y-6 border border-surface-container">
                        ...
                        <button onClick={() => navigate('/classes')} className="w-full bg-primary-container text-white py-5 rounded-full font-bold text-lg shadow-[0_8px_16px_rgba(234,112,52,0.2)] active:scale-[0.98] transition-transform">
                            Iniciar Sesión
                        </button>
                    ...
                    <div className="text-center">
                        <p className="text-on-surface-variant font-medium text-sm">
                            ¿No tienes cuenta? 
                            <Link className="text-primary-container font-bold hover:underline ml-1" to="/register">Regístrate</Link>
                        </p>
                    </div>
                </div>
            </main>
